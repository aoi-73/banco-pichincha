...
app = FastAPI(
    title="Core Financiero — Banco Pichincha",
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://banco-pichincha-9yn4.vercel.app","https://banco-pichincha-rho.vercel.app"],  # React Vite frontend
...
@app.get("/")
def root():
    return {"sistema": "Core Financiero Banco Pichinchha", "version": "1.0.0", "status": "ok"}
